...
public class User {
    ...
    public boolean equals(Object o) {
        ...
        User user = (User) o;
        return Objects.equals(getId(), user.getId()) && Objects.equals(getEmail(), user.getEmail()) && Objects.equals(getPassword(), user.getPassword()) && Objects.equals(getTaxNumber(), user.getTaxNumber()) && Objects.equals(getFullname(), user.getFullname()) && getType() == user.getType()  && Objects.equals(getCreatedAt(), user.getCreatedAt()) && Objects.equals(getUpdateAt(), user.getUpdateAt());
    }

    @Override
    public int hashCode() {
        return Objects.hash(getId(), getEmail(), getPassword(), getTaxNumber(), getFullname(), getType(), getCreatedAt(), getUpdateAt());
    }
}
